...
| Nr. | Name/Technologies | Project- /GitHub Repo Link | Description |
|--------|--------|--------|--------|
...
| 11    | **Portfolio**  (React, Nextjs) | [portfolio-gamma-brown-89.vercel.app](https://portfolio-gamma-brown-89.vercel.app/) [github.com/jili0/portfolio](https://github.com/jili0/portfolio) | A personal portfolio website where I showcase my skills, projects, and achievements. It’s designed to give visitors an easy way to explore my work and get in touch with me. |
| 12     | **Tailwind Portfolio**  (TailwindCSS) | [jingli.work/tailwind-portfolio/](https://jingli.work/tailwind-portfolio/) [github.com/jili0/tailwind-portfolio](https://github.com/jili0/tailwind-portfolio) | Another personal portfolio website that I built, using Tailwind CSS for design.
